...
export const actions = {
	...
	async fetchAllTransaksi({commit}, {page, show, search, selectedStatus}) {
		let data = await this.$axios.$get("/api/transaksi/all?page=" + page + "&show=" + show + "&search=" + search + "&status=" + selectedStatus);

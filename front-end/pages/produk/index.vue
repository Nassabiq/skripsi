			...
			<div class="grid grid-cols-12 gap-4 mt-6 mb-2">
				<div class="flex flex-col col-span-12 col lg:col-span-8 sm:col-span-6">
					<div class="relative col-span-12 my-4 md:col-span-6">
						<input type="search" class="w-full py-2 pl-8 pr-4 text-sm font-medium text-gray-800 border border-gray-200 rounded-lg shadow md:w-3/5 lg:w-2/5 focus:outline-2 focus:outline-blue-100 focus:ring-2 focus:ring-green-300" placeholder="Search..." v-model="search" @keyup="searchData" />

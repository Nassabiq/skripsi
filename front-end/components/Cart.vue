					...
					<div class="flex flex-col h-full py-6 overflow-y-scroll bg-white border-l-2 border-green-600 shadow-xl">
						...
						<div class="relative flex-1 px-4 mt-6 sm:px-6">
							...
							<div class="absolute inset-0 px-4 sm:px-6">
								<div class="h-5/6 border-2 border-gray-200 border-dashed overflow-y-auto" aria-hidden="true">
									<div class="flow-root p-4">
										<ul role="list" class="-my-6 divide-y divide-gray-200">
												...
												<li class="flex py-6 border-b-2 border-gray-200" v-for="data in cart">
													...
													<div class="flex flex-col flex-1 ml-4">
														...
														<div class="flex items-end justify-between flex-1 text-sm">
															...
															<div class="flex">
																<button type="button" class="font-medium text-indigo-600 hover:text-indigo-400">Remove</button>
															</div>
														</div>
													</div>
												</li>
											...
											<template v-else>
												<li class="flex py-6">Silahkan Login Terlebih Dahulu</li>
											</template>
										</ul>
									</div>
									<!-- {{ cart }} -->
								</div>
								<div class="my-4 flex justify-center btn btn-indigo btn-lg">

				...
				<li>
					<NuxtLink to="/pemesanan">
						<a href="#" class="relative flex flex-row items-center px-4 py-1 my-1 text-sm transition duration-200 rounded-md hover:bg-green-300 hover:text-black">
							...
							<span class="font-font-light">Kelola Pesanan</span>
						</a>
					</NuxtLink>
				</li>
				<li>
					<DropdownMenu title="Laporan" class="cursor-pointer">
						...
						<template #list>
							<NuxtLink to="/laporan/penjualan">
								<li class="dropdown-item">Laporan Penjualan</li>
							</NuxtLink>
							<NuxtLink to="/laporan/persediaan">
								<li class="dropdown-item">Laporan Persediaan</li>
							</NuxtLink>
							<NuxtLink to="/laporan/omset">
								<li class="dropdown-item">Laporan Omset dan Laba Rugi</li>
							</NuxtLink>
						</template>
					</DropdownMenu>
				</li>
...
.dropdown-item {
	@apply block px-4 py-2 mt-2 text-sm text-green-800 bg-transparent rounded-lg;
}
.dropdown-item:hover {
